<x-master-layout>
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Add New Programs</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('departments.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="name" class="block text-gray-700 font-bold mb-2">Programs Name <span class="text-red-500">*</span></label>
                ...
                <div class="mb-4">
                    <label for="code" class="block text-gray-700 font-bold mb-2">Programs Code</label>
